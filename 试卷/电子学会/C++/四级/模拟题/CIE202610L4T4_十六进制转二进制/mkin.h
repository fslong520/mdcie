...
void test(int case_num, ofstream& fout)
{
    ...
    else if (case_num == 4) fout << "F" << endl;
    else if (case_num == 5) fout << "10" << endl;
    else if (case_num == 6) fout << "FFFFFFFF" << endl;
    else if (case_num == 7) fout << "80000000" << endl;
    else if (case_num == 8) fout << "ABCDEF01" << endl;
    else if (case_num == 9) fout << "10000000" << endl;
