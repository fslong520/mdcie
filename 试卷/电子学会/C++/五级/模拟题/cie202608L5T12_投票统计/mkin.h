...
void test(int c, ofstream& o){srand(20260826+c*1000003);
 if(c==1)o<<"5\nAlice\nBob\nAlice\nCharlie\nBob"<<endl; else if(c==2)o<<"3\nX\nX\nX"<<endl;
 else if(c==3)o<<"1\nA"<<endl; else if(c==4)o<<"4\nB\nA\nB\nA"<<endl;
 else if(c>=5&&c<=15){int n=1000;o<<n<<endl;for(int i=0;i<n;i++)o<<rndname()<<endl;}
 else {int n=100000;o<<n<<endl;for(int i=0;i<n;i++)o<<rndname()<<endl;}}
#endif
